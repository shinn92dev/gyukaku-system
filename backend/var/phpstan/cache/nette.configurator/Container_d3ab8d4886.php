...
// source: phar:///Users/anthony/Desktop/project/gyukaku-system/backend/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon
...
class Container_d3ab8d4886 extends _PHPStan_6597ef616\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0359(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_d3ab8d4886 $container)
            {
    ...
    public function createServiceContainer(): Container_d3ab8d4886
    {
        return $this;
    }
