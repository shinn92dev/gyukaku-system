...
class Container_1cde3fdfda extends _PHPStan_6597ef616\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0359(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_1cde3fdfda $container)
            {
    ...
    public function createServiceContainer(): Container_1cde3fdfda
    {
        return $this;
    }
    ...
    protected function getStaticParameters(): array
    {
        return [
            ...
            'env' => [
                ...
                '_' => '/Users/anthony/.config/herd-lite/bin/php',
