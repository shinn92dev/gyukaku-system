...
class Container_19d1887fd4 extends _PHPStan_6597ef616\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0359(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_19d1887fd4 $container)
            {
    ...
    public function createServiceContainer(): Container_19d1887fd4
    {
        return $this;
    }
